...
Flight::route('GET /user', function () {
    ...
    session_start();
    $user = Flight::get('auth_service')->get_user($_SESSION['user_id']);
    Flight::json($user);
});
...
Flight::route('POST /register', function () {
    ...
    Flight::get('auth_service')->add_user($user);
});
 ...
 * )
 */
Flight::route('POST /jwt-login', function () {
    ...
    Flight::get('auth_service')->login($user);
});
